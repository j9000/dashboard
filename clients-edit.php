...
<!-- Top Bar End -->
        ...
        <div class="content-page">
        	<ol class="breadcrumb">
	<li><a href="#">Home</a></li><li class="active">Clients</li></ol>			<!-- ============================================================== -->
			<!-- Start Content here -->
			<!-- ============================================================== -->
            <div class="content">
			...
			<div class="row">
					...
					<div class="col-md-6">
						<div class="widget">
							<div class="widget-header">
								<h2>Our Client <strong>~Client Name~</strong></h2>
					...
					<div class="widget-content padding30">
						<form class="form-horizontal" role="form">
						  ...
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Current Credit</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="R12345,678">
							</div>
						  </div>
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Client Code</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  <div class="form-group">
							<label class="col-sm-4 control-label">Company Registered Name</label>
							<div class="col-sm-8">
						  ...
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Trading Name</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Registration No.</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">VAT No.</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  ...
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Physical Address</label>
							<div class="col-sm-8">
						 ...
						 <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Contact Person</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Contact No.</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
				...
				<!-- my order history -->
					<div class="col-md-6">
						<div class="widget">
							<div class="widget-header">
								<h2>Client Pricing <strong>~Client Name~</strong></h2>
