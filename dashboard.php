...
<!-- Top Bar End -->
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
					<li>
					<a href="dashboard.php" class="active"><i class='icon-home-3'></i><span>Dashboard</span></a>
					</li>
					<li>
        ...
        <div class="content-page">
        	<ol class="breadcrumb">
	<li><a href="#">Home</a></li><li class="active">Dashboard</li></ol>			<!-- ============================================================== -->
			<!-- Start Content here -->
			<!-- ============================================================== -->
            <div class="content">
				<!-- Start info box -->
					...
					<div class="col-md-5th-1 col-sm-4 col-md-offset-0 col-sm-offset-2">
						<div class="widget green-2">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">CREDIT <b>AVAILABLE</b></p>
					...
					<div class="col-md-5th-1 col-sm-4">
						<div class="widget darkblue-2">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">TOTAL <b>ORDERS</b></p>
									<h2><span class="animate-number" data-value="399" data-duration="3000">0</span> <small>Ltr</small></h2>
							...
							<div class="widget-footer">
								<div class="row">
									<div class="col-sm-12">
									<b>From</b> 01/01/18 to 31/12/18 <i class="fa fa-calendar pull-right"></i>
									</div>
								</div>
								<div class="clearfix"></div>
							</div>
					...
					<div class="col-md-5th-1 col-sm-4">
						<div class="widget orange-4">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">TOTAL <b>ORDER VALUE</b></p>
					...
					<div class="col-md-5th-1 col-sm-4">
						<div class="widget lightblue-1">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">TOTAL <b>DELIVERIES</b></p>
									<h2><span class="animate-number" data-value="70389" data-duration="3000">0</span></h2>
									<div class="clearfix"></div>
								</div>
							</div>
					...
					<div class="col-md-5th-1 col-sm-4">
						<div class="widget purple-1">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">TOTAL <b>DRIVERS</b></p>
									<h2><span class="animate-number" data-value="38" data-duration="3000">0</span></h2>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="widget-footer">
					...
					<div class="col-lg-12 portlets">
						<div id="website-statistics1" class="widget">
							<div class="widget-header transparent">
								<h2><i class="icon-chart-line"></i> <strong>Order</strong> History</h2>
