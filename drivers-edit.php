...
<!-- Top Bar End -->
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
					...
					<li>
					<a href="drivers.php" class="active"><i class='icon-person'></i><span>Drivers</span></a>
					</li>
					<li>
        ...
        <div class="content-page">
        	<ol class="breadcrumb">
	<li><a href="#">Home</a></li><li class="active">Drivers</li></ol>			<!-- ============================================================== -->
			<!-- Start Content here -->
			<!-- ============================================================== -->
            <div class="content">
		   ...
		   <!-- Page Heading Start -->
				<div class="page-heading">
            		<h1><i class='icon-person'></i> My <b>Drivers</b></h1>
            		            	</div>
            	<!-- Page Heading End-->	
				...
				<div class="widget">
					...
					<div class="widget-content padding30">
						<form class="form-horizontal" role="form">
						  ...
						  <div class="form-group">
							<label for="input-text" class="col-sm-2 control-label">Telephone No.</label>
							<div class="col-sm-10">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
							<label for="input-text" class="col-sm-2 control-label">Licence No.</label>
							<div class="col-sm-10">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						   ...
						   <div class="form-group">
							<label for="input-text" class="col-sm-2 control-label">Licence Code</label>
							<div class="col-sm-10">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
