...
<!-- Top Bar End -->
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
					...
					<li>
					<a href="orders.php" class="active"><i class='icon-doc-1'></i><span>Orders</span></a>
					</li>
					<li>
					...
					<li>
					<a href="clients.php"><i class='fa fa-users'></i><span>Manage Clients</span></a>
					</li>
					</ul>                     
					<div class="clearfix"></div>
                </div>
        ...
        <div class="content-page">
        	<ol class="breadcrumb">
	<li><a href="#">Home</a></li><li class="active">Orders</li></ol>			<!-- ============================================================== -->
			<!-- Start Content here -->
			<!-- ============================================================== -->
            <div class="content">
			...
			<div class="row">
					...
					<div class="col-md-6">
						<div class="widget">
							<div class="widget-header">
								<h2>Place <strong>Order</strong></h2>
								
							</div>
							
							<div class="widget green-2 orderpage">
							<div class="widget-content padding">
								<div class="widget-icon">
									<span>R</span>
								</div>
								<div class="text-box">
									<p class="maindata">AVAILABLE <b>CREDIT</b></p>
					...
					<div class="widget-content padding30">
						<form class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-sm-4 control-label">Order by type</label>
							<div class="col-sm-8">
						  ...
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Order Volume</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Order Value</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
						  <div class="form-group">
							<label class="col-sm-4 control-label">Specify Delivery Venue</label>
							<div class="col-sm-8">
								<select class="form-control">
								  <option>1</option>
								  <option>2</option>
						  ...
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Delivery Date</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control datepicker-input" data-mask="99-99-9999" placeholder="dd-mm-yy">
							</div>
						  </div>
						  <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Delivery Notes</label>
							<div class="col-sm-8">
							  <textarea class="form-control" rows="5" id="comment"></textarea>
							</div>
						  </div>
						 <div class="form-group">
							<label for="input-text" class="col-sm-4 control-label">Order Reference</label>
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="input-text" placeholder="Input text placeholder">
							</div>
						  </div>
				...
				<!-- my order history -->
					<div class="col-md-6">
						<div class="widget">
							...
							<div class="widget lightblue-1 orderpage">
							<div class="widget-content padding">
								<div class="widget-icon">
									<span>R</span>
								</div>
								<div class="text-box">
									<p class="maindata">ORDER <b>HISTORY</b></p>
									<h2><span class="animate-number" data-value="25153" data-duration="3000">0</span></h2>
									<div class="clearfix"></div>
								</div>
							</div>
									...
									<table id="datatables-2" class="table table-striped table-bordered" cellspacing="0" width="100%">
									        ...
									        <tbody>
												...
												<tr>
									                <td>2008/12/08</td>
									                <td>900 ltr</td>
									                <td><span class="inactive">Incomplete</span></td>
									            </tr>
												<tr>
									                <td>2008/11/08</td>
									                <td>800 ltr</td>
