...
<!-- Top Bar End -->
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
					...
					<li>
					<a href="vehicles.php" class="active"><i class='fa fa-car'></i><span>Vehicles</span></a>
					</li>
					<li>
        ...
        <div class="content-page">
        	<ol class="breadcrumb">
	<li><a href="#">Home</a></li><li class="active">Vehicles</li></ol>			<!-- ============================================================== -->
			<!-- Start Content here -->
			<!-- ============================================================== -->
            <div class="content">
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h2>My <strong>Vehicles</strong></h2>
